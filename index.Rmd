...
* Documentation that isn't obvious to the outside world
---
class:middle
...
Add roxygen comments above functions to document them
...
???
* What do I mean by external documentation?
* I mean the documentation that can be accessed by the outside world
* Via the internet, basically
---
class: middle
...
* set up tests
* version-controlled it
* made it available openly on GitHub
* documented it (externally)
