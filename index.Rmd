...
When using these slides you can:

* press 'C' to clone them in a new window
* press 'P' for presenter notes
* press 'H' for other shortcuts
...
* look at the {pkgdown} website: https://matt-dray.github.io/cabinet/
* install the package on your machine with `remotes::install_github("matt-dray/cabinet")` and using the function `cabinet::cabinet_cat("Ossie")`
---
class: title-slide, bottom
